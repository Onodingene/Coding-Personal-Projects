  ...
  return (
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <Text style={styles.heading}><Text style={{ color: '#FF7F3E' }}>PATIENT BIODATA</Text></Text>
        <View style={styles.formContainer}>
          ...
          <TextInput style={styles.textInput} placeholder='birthday/month/year'/>
          <TextInput style={styles.textInput} placeholder='Home address'/>
          <TextInput style={styles.textInput} placeholder='registrationday/month/year'/>
          <TextInput style={styles.textInput} placeholder='_matriculation number'/>
